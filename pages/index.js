...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-blue-900 text-white">
      <Head>
        <title>OK WIN VIP</title>
        <meta name="description" content="OK WIN Vip" />
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className={`relative overflow-hidden rounded-2xl shadow-2xl mb-12 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="relative z-20 p-12 md:p-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Welcome to OK WIN VIP Prediction</h2>
            ...
            <div className="mb-8">
              ...
              <p className="mt-3 text-gray-200">Sign up and start earning with Us</p>
            </div>
      ...
      <footer className="bg-black/50 backdrop-blur-md text-white mt-12">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>&copy; 2025 OK WIN VIP Prediction. All rights reserved.</p>
